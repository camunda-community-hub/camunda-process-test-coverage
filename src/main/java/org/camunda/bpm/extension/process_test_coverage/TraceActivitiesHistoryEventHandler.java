...
public class TraceActivitiesHistoryEventHandler implements HistoryEventHandler {
	...
	public void handleEvent(HistoryEvent historyEvent) {
		if (historyEvent instanceof HistoricActivityInstanceEventEntity) {
			...
			if (activityEvent.getStartTime() != null) {
				CoveredElement activity = CoveredElementBuilder.createTrace(activityEvent.getProcessDefinitionId())
						.withActivityId(activityEvent.getActivityId()).build();
