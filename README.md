...
This Camunda BPM community extension **visualises** test process **pathes** and **checks** your process model **coverage** ratio. Running typical JUnit tests will on the fly create *.html files in your build `./target` folder - just as this one:
