...
This Camunda BPM community extension **visualises** test process **pathes** and **checks** your process model **coverage** ratio. Running your typical JUnit tests now creates some *.html files in your build output folder. Open one of them and see what your test method did:
