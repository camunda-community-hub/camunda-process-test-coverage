...
This Camunda BPM community extension **visualises** test process **pathes** and **checks** your process model **coverage** ratio. Running  your typical JUnit tests now leaves *.html files in your build output. Click on one of them and check what your test method did:
