...
This Camunda BPM community extension **visualises** test process **pathes** and **asserts** your expected process model **coverage** ratio. Running your typical JUnit process test will now on the fly create *.html files in your build `./target` folder - just as this one:
