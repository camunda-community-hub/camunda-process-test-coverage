...
This Camunda BPM community extension **visualises** test process **pathes** and **checks** your process model **coverage** ratio. Running your typical JUnit tests will now on the fly create *.html files in your build output folder. Open it and view your test run:
